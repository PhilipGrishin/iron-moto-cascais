...
- 187 HTML files in the repository: 184 sitemap URLs, `404.html`, and 2 legacy noindex redirect stubs.
- 184 sitemap URLs: 46 indexable path patterns times 4 languages.
- JSON-LD, canonical, Open Graph, Twitter metadata, and hreflang are generated per language.
- Reviews use a two-layer system: live rating/count from the Cloudflare Worker snapshot, curated visible cards from `assets/reviews-curated.json`, and home-page JSON-LD generated by `scripts/build/build_reviews_schema.py`.
