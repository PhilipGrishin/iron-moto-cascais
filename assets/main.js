...
const I18N = {
  en: {
    "nav.services":"Services","nav.brands":"Brands","nav.projects":"Projects","nav.pricing":"Pricing","nav.about":"About","nav.aboutUs":"About us","nav.community":"Community","nav.reviews":"Reviews","nav.faq":"FAQ","nav.contact":"Contact","nav.blog":"Blog","nav.news":"News","nav.allServices":"All services","nav.allProjects":"All projects","nav.preInsp":"Pre-purchase inspection","nav.tyreServ":"Tyre fitting & wheel balancing","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.bmwServ":"BMW Motorrad service","nav.hdServ":"Harley-Davidson service","nav.ducServ":"Ducati service","nav.suzukiServ":"Suzuki service","nav.hondaServ":"Honda service",
    ...
    "hero.pill1":"Cascais · Greater Lisbon","hero.pill2":"Since 2010","hero.pill3":"<a href=\"/\" hreflang=\"en\">EN</a><span class=\"lang-sep\">·</span><a href=\"/ru/\" hreflang=\"ru\">RU</a><span class=\"lang-sep\">·</span><a href=\"/uk/\" hreflang=\"uk\">UK</a><span class=\"lang-sep\">·</span><a href=\"/pt/\" hreflang=\"pt\">PT</a>",
    "hero.title1":"Premium","hero.title2":"motorcycle","hero.title3":"service","hero.title4":"in Cascais",
    "hero.languageLine":"We speak English.",
  ...
  ru: {
    "nav.services":"Услуги","nav.brands":"Бренды","nav.projects":"Проекты","nav.pricing":"Цены","nav.about":"О нас","nav.aboutUs":"О нас","nav.community":"Сообщество","nav.reviews":"Отзывы","nav.faq":"FAQ","nav.contact":"Контакты","nav.blog":"Блог","nav.news":"Новости","nav.allServices":"Все услуги","nav.allProjects":"Все проекты","nav.preInsp":"Инспекция перед покупкой","nav.tyreServ":"Шиномонтаж и балансировка","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.bmwServ":"Сервис BMW Motorrad","nav.hdServ":"Сервис Harley-Davidson","nav.ducServ":"Сервис Ducati","nav.suzukiServ":"Сервис Suzuki","nav.hondaServ":"Сервис Honda",
    ...
    "hero.pill1":"Кашкайш · Лиссабон","hero.pill2":"С 2010 года","hero.pill3":"<a href=\"/\" hreflang=\"en\">EN</a><span class=\"lang-sep\">·</span><a href=\"/ru/\" hreflang=\"ru\">RU</a><span class=\"lang-sep\">·</span><a href=\"/uk/\" hreflang=\"uk\">UK</a><span class=\"lang-sep\">·</span><a href=\"/pt/\" hreflang=\"pt\">PT</a>",
    "hero.title1":"Премиальный","hero.title2":"мотосервис","hero.title3":"в Кашкайше","hero.title4":"",
    "hero.languageLine":"Мы говорим по-русски.",
  ...
  uk: {
    "nav.services":"Послуги","nav.brands":"Бренди","nav.projects":"Проєкти","nav.pricing":"Ціни","nav.about":"Про нас","nav.aboutUs":"Про нас","nav.community":"Спільнота","nav.reviews":"Відгуки","nav.faq":"FAQ","nav.contact":"Контакти","nav.blog":"Блог","nav.news":"Новини","nav.allServices":"Усі послуги","nav.allProjects":"Усі проєкти","nav.preInsp":"Інспекція перед купівлею","nav.tyreServ":"Шиномонтаж і балансування","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.bmwServ":"Сервіс BMW Motorrad","nav.hdServ":"Сервіс Harley-Davidson","nav.ducServ":"Сервіс Ducati","nav.suzukiServ":"Сервіс Suzuki","nav.hondaServ":"Сервіс Honda",
    ...
    "hero.pill1":"Кашкайш · Лісабон","hero.pill2":"З 2010 року","hero.pill3":"<a href=\"/\" hreflang=\"en\">EN</a><span class=\"lang-sep\">·</span><a href=\"/ru/\" hreflang=\"ru\">RU</a><span class=\"lang-sep\">·</span><a href=\"/uk/\" hreflang=\"uk\">UK</a><span class=\"lang-sep\">·</span><a href=\"/pt/\" hreflang=\"pt\">PT</a>",
    "hero.title1":"Преміальний","hero.title2":"мотосервіс","hero.title3":"у Кашкайші","hero.title4":"",
    "hero.languageLine":"Ми розмовляємо українською.",
  ...
  pt: {
    "nav.services":"Serviços","nav.brands":"Marcas","nav.projects":"Projetos","nav.pricing":"Preços","nav.about":"Sobre","nav.aboutUs":"Sobre nós","nav.community":"Comunidade","nav.reviews":"Avaliações","nav.faq":"FAQ","nav.contact":"Contacto","nav.blog":"Blog","nav.news":"Notícias","nav.allServices":"Todos os serviços","nav.allProjects":"Todos os projetos","nav.preInsp":"Inspeção pré-compra","nav.tyreServ":"Pneus e equilibragem","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.bmwServ":"Serviço BMW Motorrad","nav.hdServ":"Serviço Harley-Davidson","nav.ducServ":"Serviço Ducati","nav.suzukiServ":"Serviço Suzuki","nav.hondaServ":"Serviço Honda",
    ...
    "hero.pill1":"Cascais · Grande Lisboa","hero.pill2":"Desde 2010","hero.pill3":"<a href=\"/\" hreflang=\"en\">EN</a><span class=\"lang-sep\">·</span><a href=\"/ru/\" hreflang=\"ru\">RU</a><span class=\"lang-sep\">·</span><a href=\"/uk/\" hreflang=\"uk\">UK</a><span class=\"lang-sep\">·</span><a href=\"/pt/\" hreflang=\"pt\">PT</a>",
    "hero.title1":"Serviço","hero.title2":"premium de moto","hero.title3":"em Cascais","hero.title4":"",
    "hero.languageLine":"Falamos português.",
