...
const I18N = {
  ...
  ru: {
    ...
    "teamBanner.title":"Команда, которая <span class=\"accent\">берёт трубку.</span>","teamBanner.sub":"Инженеры мирового уровня за каждым рутинным сервисом. Те же руки. Тот же стандарт. Теперь в Кашкайше.","teamBanner.row1":"<strong>15+</strong> лет строим, гоняем, чиним","teamBanner.row2":"<strong>3×</strong> чемпионы мира","teamBanner.row3":"Кашкайш · Лиссабон · Португалия","story.eyebrow":"Наша история","story.title":"От мастерской в Харькове<br/>до подиумов мировых<br/>чемпионатов",
  ...
  uk: {
    ...
    "teamBanner.title":"Команда, що <span class=\"accent\">бере слухавку.</span>","teamBanner.sub":"Інженери світового рівня за кожним рутинним сервісом. Ті самі руки. Той самий стандарт. Тепер у Кашкайші.","teamBanner.row1":"<strong>15+</strong> років будуємо, гонимо, лагодимо","teamBanner.row2":"<strong>3×</strong> чемпіони світу","teamBanner.row3":"Кашкайш · Лісабон · Португалія","story.eyebrow":"Наша історія","story.title":"Від майстерні в Харкові<br/>до подіумів світових<br/>чемпіонатів",
