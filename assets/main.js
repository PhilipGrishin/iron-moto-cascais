...
const I18N = {
  en: {
    ...
    "services.learn":"Learn more","services.s1.link":"Motorcycle service and repair in Cascais","services.s2.link":"Motorcycle parts to order, fitted in-house","services.s3.link":"Motorcycle upgrades and tuning in Cascais","services.s4.link":"Custom motorcycles: complete projects only","services.eyebrow":"What we do","services.title":"Service. Parts.<br/>Upgrades. Custom.","services.sub":"Iron Custom Motors services motorcycles, supplies spare parts and consumables, and offers tuning and upgrade solutions from major global catalogs and brands.",
    ...
    "services.s5.title":"Tyre fitting & wheel balancing","services.s5.desc":"Motorcycle-specific tyre fitting and wheel balancing for wheels up to 30 inches and 400 mm, including spoked, vintage, Harley fat and custom wheels.","services.cta5":"Motorcycle tyre fitting from 40 € per wheel",
    "services.s6.title":"Pre-purchase inspection","services.s6.desc":"Independent expert check before you buy a used motorcycle in Portugal. Mechanics, electrics, frame and hidden wear — written report with photos within 24 hours.","services.cta6":"Pre-purchase inspection, 150 € fixed price",
    "pricing.eyebrow":"Pricing · 2026","pricing.title":"Transparent pricing,<br/>no surprises.","pricing.sub":"Written estimates before any work begins. Fixed or \"from\" prices for every service. All taxes included. The full 2026 price list covers diagnostics, scheduled maintenance, brakes, valves, wheels, accessories, tuning and seasonal preparation.","pricing.p1.title":"Pre-purchase inspection","pricing.p1.desc":"Full technical check before you buy a used motorcycle in Portugal.","pricing.p1.price":"150","pricing.p1.cur":"EUR","pricing.p2.title":"Scheduled service","pricing.p2.desc":"Manufacturer-spec maintenance. Consumables included in the price.","pricing.p2.price":"150","pricing.p2.cur":"EUR","pricing.p2.from":"from","pricing.p3.title":"Fault diagnostics","pricing.p3.desc":"We find the root cause, not just the symptom. Electrics, engine, running gear.","pricing.p3.price":"50–350","pricing.p3.cur":"EUR","pricing.p4.title":"Hourly work","pricing.p4.desc":"Anything outside the price list — transparent time tracking, written estimate up front.","pricing.p4.price":"50","pricing.p4.cur":"EUR / hour","pricing.cta":"Full price list 2026, taxes included","pricing.tax":"All prices include taxes and fees",
  ...
  ru: {
    ...
    "services.learn":"Подробнее","services.s1.link":"ТО и ремонт мотоциклов в Кашкайше","services.s2.link":"Мотозапчасти под заказ, установка здесь же","services.s3.link":"Тюнинг и апгрейды мотоциклов в Кашкайше","services.s4.link":"Кастом-мотоциклы: только проекты целиком","services.eyebrow":"Что мы делаем","services.title":"Сервис. Запчасти.<br/>Апгрейды. Кастом.","services.sub":"Iron Custom Motors обслуживает мотоциклы, поставляет оригинальные и тюнинг-запчасти, расходники и аксессуары из ведущих международных каталогов и брендов.",
    ...
    "services.s5.title":"Шиномонтаж и балансировка","services.s5.desc":"Профильный мотоциклетный шиномонтаж и балансировка колёс до 30 дюймов и 400 мм, включая спицы, винтаж, Harley fat и кастом.","services.cta5":"Шиномонтаж мотоциклов от 40 € за колесо",
    "services.s6.title":"Предпокупочная инспекция","services.s6.desc":"Независимая экспертная проверка перед покупкой б/у мотоцикла в Португалии. Механика, электрика, рама и скрытый износ — письменный отчёт с фото в течение 24 часов.","services.cta6":"Проверка мотоцикла перед покупкой, 150 €",
    "pricing.eyebrow":"Прайс-лист · 2026","pricing.title":"Прозрачные цены,<br/>без сюрпризов.","pricing.sub":"Письменная смета до начала работ. Фиксированные цены или «от» на каждую услугу. Все налоги включены. Полный прайс 2026 года покрывает диагностику, плановое ТО, тормоза, клапаны, колёса, аксессуары, тюнинг и сезонную подготовку.","pricing.p1.title":"Диагностика перед покупкой","pricing.p1.desc":"Полная техническая проверка перед покупкой б/у мотоцикла в Португалии.","pricing.p1.price":"150","pricing.p1.cur":"EUR","pricing.p2.title":"Плановое ТО","pricing.p2.desc":"Обслуживание по нормативам производителя. Расходники включены в цену.","pricing.p2.price":"150","pricing.p2.cur":"EUR","pricing.p2.from":"от","pricing.p3.title":"Диагностика неисправностей","pricing.p3.desc":"Ищем причину, а не симптом. Электрика, двигатель, ходовая часть.","pricing.p3.price":"50–350","pricing.p3.cur":"EUR","pricing.p4.title":"Почасовая работа","pricing.p4.desc":"Всё, что не вошло в прайс — прозрачный учёт времени, смета вперёд.","pricing.p4.price":"50","pricing.p4.cur":"EUR / час","pricing.cta":"Полный прайс-лист 2026, цены с налогами","pricing.tax":"Все цены включают налоги и сборы",
  ...
  uk: {
    ...
    "services.learn":"Детальніше","services.s1.link":"ТО і ремонт мотоциклів у Кашкайші","services.s2.link":"Мотозапчастини під замовлення, монтаж тут же","services.s3.link":"Тюнінг і апгрейди мотоциклів у Кашкайші","services.s4.link":"Кастом-мотоцикли: лише повні проєкти","services.eyebrow":"Що ми робимо","services.title":"Сервіс. Запчастини.<br/>Апгрейди. Кастом.","services.sub":"Iron Custom Motors обслуговує мотоцикли, постачає оригінальні і тюнінг-запчастини, витратні матеріали та аксесуари з провідних міжнародних каталогів і брендів.",
    ...
    "services.s5.title":"Шиномонтаж і балансування","services.s5.desc":"Профільний мотоциклетний шиномонтаж і балансування коліс до 30 дюймів і 400 мм, зокрема спиці, вінтаж, Harley fat і кастом.","services.cta5":"Шиномонтаж мотоциклів від 40 € за колесо",
    "services.s6.title":"Інспекція перед купівлею","services.s6.desc":"Незалежна експертна перевірка перед купівлею б/в мотоцикла в Португалії. Механіка, електрика, рама та прихований знос — письмовий звіт із фото протягом 24 годин.","services.cta6":"Перевірка мотоцикла перед купівлею, 150 €",
    "pricing.eyebrow":"Прайс-лист · 2026","pricing.title":"Прозорі ціни,<br/>без сюрпризів.","pricing.sub":"Письмовий кошторис до початку робіт. Фіксовані ціни або «від» на кожну послугу. Усі податки включено. Повний прайс 2026 року покриває діагностику, планове ТО, гальма, клапани, колеса, аксесуари, тюнінг і сезонну підготовку.","pricing.p1.title":"Діагностика перед купівлею","pricing.p1.desc":"Повна технічна перевірка перед купівлею б/в мотоцикла в Португалії.","pricing.p1.price":"150","pricing.p1.cur":"EUR","pricing.p2.title":"Планове ТО","pricing.p2.desc":"Обслуговування за нормативами виробника. Витратні матеріали включено в ціну.","pricing.p2.price":"150","pricing.p2.cur":"EUR","pricing.p2.from":"від","pricing.p3.title":"Діагностика несправностей","pricing.p3.desc":"Шукаємо причину, а не симптом. Електрика, двигун, ходова частина.","pricing.p3.price":"50–350","pricing.p3.cur":"EUR","pricing.p4.title":"Погодинна робота","pricing.p4.desc":"Усе, що не увійшло до прайсу — прозорий облік часу, кошторис наперед.","pricing.p4.price":"50","pricing.p4.cur":"EUR / год","pricing.cta":"Повний прайс 2026, ціни з податками","pricing.tax":"Усі ціни включають податки та збори",
  ...
  pt: {
    ...
    "hero.scroll":"Scroll · Iron Custom Motors",
    "services.learn":"Saber mais","services.s1.link":"Revisão e reparação de motas em Cascais","services.s2.link":"Peças de moto por encomenda, montadas cá","services.s3.link":"Tuning e upgrades de motos em Cascais","services.s4.link":"Motas custom: só projetos completos","services.eyebrow":"O que fazemos","services.title":"Serviço. Peças.<br/>Upgrades. Custom.","services.sub":"Iron Custom Motors faz serviço a motos, fornece peças e consumíveis, e oferece soluções de tuning e upgrade dos principais catálogos e marcas internacionais.",
    ...
    "services.s5.title":"Pneus e equilibragem","services.s5.desc":"Montagem de pneus de mota e equilibragem em equipamento dedicado para rodas até 30 polegadas e 400 mm, incluindo raios, clássicas, Harley fat e custom.","services.cta5":"Montagem de pneus de mota desde 40 €",
    "services.s6.title":"Inspeção pré-compra","services.s6.desc":"Verificação técnica independente antes de comprar uma mota usada em Portugal. Mecânica, elétrica, quadro e desgaste oculto — relatório escrito com fotos em 24 horas.","services.cta6":"Inspeção pré-compra de mota, 150 € fixos",
    "pricing.eyebrow":"Tabela de preços · 2026","pricing.title":"Preços transparentes,<br/>sem surpresas.","pricing.sub":"Orçamento escrito antes do início dos trabalhos. Preços fixos ou \"desde\" para cada serviço. Todos os impostos incluídos. A tabela completa de 2026 cobre diagnóstico, manutenção programada, travões, válvulas, rodas, acessórios, afinação e preparação sazonal.","pricing.p1.title":"Inspeção pré-compra","pricing.p1.desc":"Verificação técnica completa antes de comprar uma moto usada em Portugal.","pricing.p1.price":"150","pricing.p1.cur":"EUR","pricing.p2.title":"Manutenção programada","pricing.p2.desc":"Manutenção segundo normas do fabricante. Consumíveis incluídos no preço.","pricing.p2.price":"150","pricing.p2.cur":"EUR","pricing.p2.from":"desde","pricing.p3.title":"Diagnóstico de avarias","pricing.p3.desc":"Procuramos a causa, não o sintoma. Elétrica, motor, chassis.","pricing.p3.price":"50–350","pricing.p3.cur":"EUR","pricing.p4.title":"Trabalho à hora","pricing.p4.desc":"Tudo o que não está na tabela — registo transparente do tempo, orçamento prévio.","pricing.p4.price":"50","pricing.p4.cur":"EUR / hora","pricing.cta":"Tabela de preços 2026, impostos incluídos","pricing.tax":"Todos os preços incluem impostos e taxas",
