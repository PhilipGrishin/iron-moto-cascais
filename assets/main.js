...
const I18N = {
  en: {
    ...
    "hero.expatHubLink":"English-speaking workshop",
  ...
  ru: {
    "nav.services":"Услуги","nav.brands":"Бренды","nav.authorizedDealer":"Официальный дилер","nav.projects":"Проекты","nav.pricing":"Цены","nav.about":"О нас","nav.aboutUs":"О нас","nav.community":"Сообщество","nav.reviews":"Отзывы","nav.faq":"FAQ","nav.contact":"Контакты","nav.blog":"Блог","nav.news":"Новости","nav.allServices":"Все услуги","nav.allProjects":"Все проекты","nav.preInsp":"Инспекция перед покупкой","nav.tyreServ":"Шиномонтаж и балансировка","nav.expatWorkshop":"Англоязычная мастерская","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.brandRoyalEnfield":"Royal Enfield","nav.brandTriumph":"Triumph","nav.bmwServ":"Сервис BMW Motorrad","nav.hdServ":"Сервис Harley-Davidson","nav.ducServ":"Сервис Ducati","nav.suzukiServ":"Сервис Suzuki","nav.hondaServ":"Сервис Honda",
    ...
    "hero.expatHubLink":"Англоязычная мастерская",
  ...
  uk: {
    "nav.services":"Послуги","nav.brands":"Бренди","nav.authorizedDealer":"Офіційний дилер","nav.projects":"Проєкти","nav.pricing":"Ціни","nav.about":"Про нас","nav.aboutUs":"Про нас","nav.community":"Спільнота","nav.reviews":"Відгуки","nav.faq":"FAQ","nav.contact":"Контакти","nav.blog":"Блог","nav.news":"Новини","nav.allServices":"Усі послуги","nav.allProjects":"Усі проєкти","nav.preInsp":"Інспекція перед купівлею","nav.tyreServ":"Шиномонтаж і балансування","nav.expatWorkshop":"Англомовна майстерня","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.brandRoyalEnfield":"Royal Enfield","nav.brandTriumph":"Triumph","nav.bmwServ":"Сервіс BMW Motorrad","nav.hdServ":"Сервіс Harley-Davidson","nav.ducServ":"Сервіс Ducati","nav.suzukiServ":"Сервіс Suzuki","nav.hondaServ":"Сервіс Honda",
    ...
    "hero.expatHubLink":"Англомовна майстерня",
  ...
  pt: {
    "nav.services":"Serviços","nav.brands":"Marcas","nav.authorizedDealer":"Revendedor Oficial","nav.projects":"Projetos","nav.pricing":"Preços","nav.about":"Sobre","nav.aboutUs":"Sobre nós","nav.community":"Comunidade","nav.reviews":"Avaliações","nav.faq":"FAQ","nav.contact":"Contacto","nav.blog":"Blog","nav.news":"Notícias","nav.allServices":"Todos os serviços","nav.allProjects":"Todos os projetos","nav.preInsp":"Inspeção pré-compra","nav.tyreServ":"Pneus e equilibragem","nav.expatWorkshop":"Oficina que fala inglês","nav.brandHarley":"Harley-Davidson","nav.brandBmw":"BMW Motorrad","nav.brandDucati":"Ducati","nav.brandSuzuki":"Suzuki","nav.brandHonda":"Honda","nav.brandRoyalEnfield":"Royal Enfield","nav.brandTriumph":"Triumph","nav.bmwServ":"Serviço BMW Motorrad","nav.hdServ":"Serviço Harley-Davidson","nav.ducServ":"Serviço Ducati","nav.suzukiServ":"Serviço Suzuki","nav.hondaServ":"Serviço Honda",
    ...
    "hero.expatHubLink":"Oficina que fala inglês",
