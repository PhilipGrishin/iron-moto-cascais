...
const I18N = {
  en: {
    "nav.services":"Services","nav.projects":"Projects","nav.pricing":"Pricing","nav.about":"About","nav.community":"Community","nav.reviews":"Reviews","nav.faq":"FAQ","nav.contact":"Contact","nav.news":"News","nav.preInsp":"Pre-purchase inspection","nav.bmwServ":"BMW Motorrad service","nav.hdServ":"Harley-Davidson service","nav.ducServ":"Ducati service",
  ...
  ru: {
    "nav.services":"Услуги","nav.projects":"Проекты","nav.pricing":"Цены","nav.about":"О нас","nav.community":"Сообщество","nav.reviews":"Отзывы","nav.faq":"FAQ","nav.contact":"Контакты","nav.news":"Новости","nav.preInsp":"Инспекция перед покупкой","nav.bmwServ":"Сервис BMW Motorrad","nav.hdServ":"Сервис Harley-Davidson","nav.ducServ":"Сервис Ducati",
  ...
  uk: {
    "nav.services":"Послуги","nav.projects":"Проєкти","nav.pricing":"Ціни","nav.about":"Про нас","nav.community":"Спільнота","nav.reviews":"Відгуки","nav.faq":"FAQ","nav.contact":"Контакти","nav.news":"Новини","nav.preInsp":"Інспекція перед купівлею","nav.bmwServ":"Сервіс BMW Motorrad","nav.hdServ":"Сервіс Harley-Davidson","nav.ducServ":"Сервіс Ducati",
  ...
  pt: {
    "nav.services":"Serviços","nav.projects":"Projetos","nav.pricing":"Preços","nav.about":"Sobre","nav.community":"Comunidade","nav.reviews":"Avaliações","nav.faq":"FAQ","nav.contact":"Contacto","nav.news":"Notícias","nav.preInsp":"Inspeção pré-compra","nav.bmwServ":"Serviço BMW Motorrad","nav.hdServ":"Serviço Harley-Davidson","nav.ducServ":"Serviço Ducati",
