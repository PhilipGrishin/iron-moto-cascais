...
const I18N = {
  en: {
    ...
    "homeHarley.eyebrow":"Harley-Davidson at ICM","homeHarley.title":"Everything for your Harley.","homeHarley.text":"Service, diagnostics, tuning, custom builds and parts in one independent specialist workshop.","homeHarley.link":"Open Harley Hub","homeHarley.alt":"Harley-Davidson motorcycles at Iron Custom Motors in Cascais","cs.harleyEyebrow":"Harley-Davidson","cs.harleyTitle":"Planning a Harley custom?","cs.harleyText":"Explore the dedicated Harley custom page for our builds, project process and ways to begin.","cs.harleyLink":"Explore Harley custom",
  ...
  ru: {
    ...
    "homeHarley.eyebrow":"Harley-Davidson в ICM","homeHarley.title":"Всё для вашего Harley.","homeHarley.text":"Сервис, диагностика, тюнинг, кастом-проекты и запчасти в одной независимой специализированной мастерской.","homeHarley.link":"Открыть Harley Hub","homeHarley.alt":"Мотоциклы Harley-Davidson в Iron Custom Motors, Кашкайш","cs.harleyEyebrow":"Harley-Davidson","cs.harleyTitle":"Планируете кастом Harley?","cs.harleyText":"На отдельной странице Harley custom собраны наши проекты, процесс работы и варианты старта.","cs.harleyLink":"Смотреть Harley custom",
  ...
  uk: {
    ...
    "homeHarley.eyebrow":"Harley-Davidson в ICM","homeHarley.title":"Усе для вашого Harley.","homeHarley.text":"Сервіс, діагностика, тюнінг, кастом-проєкти та запчастини в одній незалежній спеціалізованій майстерні.","homeHarley.link":"Відкрити Harley Hub","homeHarley.alt":"Мотоцикли Harley-Davidson в Iron Custom Motors, Кашкайш","cs.harleyEyebrow":"Harley-Davidson","cs.harleyTitle":"Плануєте кастом Harley?","cs.harleyText":"На окремій сторінці Harley custom зібрані наші проєкти, процес роботи та варіанти старту.","cs.harleyLink":"Дивитися Harley custom",
  ...
  pt: {
    ...
    "homeHarley.eyebrow":"Harley-Davidson na ICM","homeHarley.title":"Tudo para a sua Harley.","homeHarley.text":"Serviço, diagnóstico, tuning, projetos custom e peças numa oficina especialista independente.","homeHarley.link":"Abrir o Harley Hub","homeHarley.alt":"Motas Harley-Davidson na Iron Custom Motors, Cascais","cs.harleyEyebrow":"Harley-Davidson","cs.harleyTitle":"Está a planear uma Harley custom?","cs.harleyText":"Explore a página dedicada a Harley custom para conhecer as nossas construções, o processo e as formas de começar.","cs.harleyLink":"Explorar Harley custom",
