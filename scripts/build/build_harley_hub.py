...
PAGE_CSS = """
.harley-hero{position:relative;display:grid;min-height:min(720px,76vh);align-items:end;overflow:hidden;border-bottom:1px solid var(--border);background:#050505}
.harley-hero-media,.harley-hero-media img,.harley-hero-shade{position:absolute;inset:0;width:100%;height:100%}
.harley-hero-media img{object-fit:cover;object-position:center}
.harley-hero-shade{background:linear-gradient(180deg,rgba(0,0,0,.16) 0%,rgba(0,0,0,.28) 45%,rgba(0,0,0,.9) 100%)}
.harley-hero .container{position:relative;z-index:2;padding-top:150px;padding-bottom:58px}
.harley-hero .crumb{margin-bottom:22px}
.harley-hero h1{max-width:980px;color:#fff;font-family:var(--font-display);font-size:clamp(46px,7vw,100px);font-weight:900;line-height:.9;text-transform:uppercase}
.harley-section{padding:72px 0;border-bottom:1px solid var(--border);background:#0a0a0a}
.harley-section:nth-of-type(even){background:#0d0d0d}
.harley-section .section-heading{display:grid;grid-template-columns:minmax(240px,.7fr) minmax(0,1.3fr);gap:50px;margin-bottom:30px}
.harley-section h2{max-width:760px;color:#fff;font-family:var(--font-display);font-size:clamp(30px,4.2vw,58px);font-weight:850;line-height:.95;text-transform:uppercase}
.harley-copy{max-width:820px;margin-left:auto}
.harley-copy p{margin:0 0 18px;color:var(--text-dim);font-size:17px;line-height:1.72}
...
.harley-intro .harley-copy p{color:#d5d5d5;font-size:clamp(18px,2.1vw,24px);line-height:1.58}
.harley-step{padding:18px 0;border-bottom:1px solid var(--border)}
.hub-service-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-top:26px}
.hub-service-tile{position:relative;display:flex;min-height:210px;flex-direction:column;justify-content:space-between;gap:22px;padding:28px;border:1px solid var(--border);border-radius:8px;background:#111;color:#fff;text-decoration:none;transition:transform .2s ease,border-color .2s ease,background .2s ease}
...
.hub-service-tile h3{max-width:21ch;color:#fff;font-family:var(--font-display);font-size:clamp(23px,2.4vw,34px);font-weight:800;line-height:1;text-transform:uppercase}
.hub-service-tile p{max-width:48ch;margin:0;color:var(--text-dim);font-size:15px;line-height:1.58}
.hub-service-tile .tile-arrow{color:var(--accent);font-size:26px}
.harley-feed{display:grid;gap:22px;margin-top:34px}
.harley-feed-card{display:grid;grid-template-columns:minmax(300px,.95fr) minmax(0,1.05fr);min-height:340px;overflow:hidden;border:1px solid var(--border);border-radius:8px;background:#101010;color:#fff;text-decoration:none}
.harley-feed-card picture,.harley-feed-card img{width:100%;height:100%}
.harley-feed-card img{display:block;object-fit:cover}
.harley-feed-body{display:flex;flex-direction:column;justify-content:center;padding:34px}
.harley-feed-date{margin-bottom:13px;color:var(--accent);font-family:var(--font-ui);font-size:12px;font-weight:700;text-transform:uppercase}
.harley-feed-card h3{margin-bottom:16px;color:#fff;font-family:var(--font-display);font-size:clamp(25px,2.8vw,40px);font-weight:850;line-height:1;text-transform:uppercase}
.harley-feed-card p{margin:0 0 20px;color:var(--text-dim);font-size:15px;line-height:1.6}
.harley-more{color:var(--accent);font-family:var(--font-ui);font-size:13px;font-weight:750;text-transform:uppercase}
.portfolio-list{display:grid;gap:26px;margin-top:34px}
.portfolio-row{display:grid;grid-template-columns:minmax(380px,1.08fr) minmax(0,.92fr);min-height:390px;overflow:hidden;border:1px solid var(--border);border-radius:8px;background:#101010}
.portfolio-row picture,.portfolio-row img{width:100%;height:100%}
.portfolio-row img{display:block;object-fit:cover}
.portfolio-body{display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:38px}
.portfolio-body h3{margin-bottom:18px;color:#fff;font-family:var(--font-display);font-size:clamp(30px,4vw,54px);font-weight:900;line-height:.95;text-transform:uppercase}
.portfolio-body p{margin:0 0 25px;color:var(--text-dim);font-size:16px;line-height:1.65}
.harley-faq{max-width:900px;margin-left:auto}
.harley-faq details{border-top:1px solid var(--border)}
.harley-faq details:last-child{border-bottom:1px solid var(--border)}
.harley-faq summary{display:flex;cursor:pointer;align-items:center;justify-content:space-between;gap:24px;padding:22px 0;color:#fff;font-family:var(--font-ui);font-size:17px;font-weight:700;list-style:none}
.harley-faq summary::-webkit-details-marker{display:none}
.harley-faq summary::after{content:"+";flex:none;color:var(--accent);font-size:24px}
.harley-faq details[open] summary::after{content:"−"}
.harley-faq .answer{padding:0 42px 22px 0;color:var(--text-dim);font-size:16px;line-height:1.65}
.harley-faq .answer a{color:var(--accent)}
.harley-cta{text-align:center}
.harley-cta .section-heading{display:block;margin-bottom:24px}
...
@media(max-width:900px){
  .harley-section .section-heading{grid-template-columns:1fr;gap:18px}
...
@media(max-width:680px){
  .harley-hero{min-height:68vh}
  .harley-hero .container{padding-top:120px;padding-bottom:42px}
  .harley-hero h1{font-size:clamp(40px,13vw,62px)}
  .harley-section{padding:54px 0}
  .hub-service-grid{grid-template-columns:1fr}
  .hub-service-tile{min-height:180px;padding:23px}
  .harley-feed-body,.portfolio-body{padding:25px}
  .harley-faq summary{font-size:16px}
}
"""
...
def detect_cache_bust() -> str:
    ...
    return match.group(1) if match else "20260724a"
