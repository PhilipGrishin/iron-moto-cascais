...
LABELS = {
    "en": {
        "page_title": "Motorcycle Service Price List 2025 — Cascais | Iron Custom Motors",
        "page_description": "2025 price list for motorcycle service in Cascais — diagnostics, scheduled maintenance, brakes, valves, tyres, accessories and tuning. Transparent pricing, written estimates, taxes included.",
        "eyebrow": "Price list · 2025",
        "h1": "Where engineering<br/>meets service",
    ...
    "ru": {
        "page_title": "Прайс на сервис мотоциклов 2025 — Кашкайш | Iron Custom Motors",
        "page_description": "Прайс-лист 2025 на сервис мотоциклов в Кашкайше — диагностика, плановое ТО, тормоза, клапаны, шины, аксессуары и тюнинг. Прозрачные цены, письменные сметы, налоги включены.",
        "eyebrow": "Прайс-лист · 2025",
        "h1": "Там, где инженерия<br/>встречает сервис",
    ...
    "uk": {
        "page_title": "Прайс на сервіс мотоциклів 2025 — Кашкайш | Iron Custom Motors",
        "page_description": "Прайс-лист 2025 на сервіс мотоциклів у Кашкайші — діагностика, планове ТО, гальма, клапани, шини, аксесуари та тюнінг. Прозорі ціни, письмові кошториси, податки включено.",
        "eyebrow": "Прайс-лист · 2025",
        "h1": "Там, де інженерія<br/>зустрічає сервіс",
    ...
    "pt": {
        "page_title": "Tabela de Preços Serviço de Motos 2025 — Cascais | Iron Custom Motors",
        "page_description": "Tabela de preços 2025 para serviço de motos em Cascais — diagnóstico, manutenção programada, travões, válvulas, pneus, acessórios e afinação. Preços transparentes, orçamentos escritos, impostos incluídos.",
        "eyebrow": "Tabela de preços · 2025",
        "h1": "Onde a engenharia<br/>encontra o serviço",
